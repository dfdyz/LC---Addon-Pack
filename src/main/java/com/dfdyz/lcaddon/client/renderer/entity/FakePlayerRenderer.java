...
public class FakePlayerRenderer extends LivingEntityRenderer<FakePlayer, PlayerModel<FakePlayer>> {
    public FakePlayerRenderer(EntityRendererProvider.Context context) {
        ...
        //this.addLayer(new PlayerItemInHandLayer<>(this, context.getEntityRenderDispatcher().ge));
    }

    @Override
    public void render(FakePlayer p_117788_, float p_117789_, float pt, PoseStack p_117791_, MultiBufferSource p_117792_, int p_117793_) {
        this.setModelProperties(p_117788_);
        //if (net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.RenderPlayerEvent.Pre(p_117788_, this, pt, p_117791_, p_117792_, p_117793_))) return;
        super.render(p_117788_, p_117789_, pt, p_117791_, p_117792_, p_117793_);
        //net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.RenderPlayerEvent.Post(p_117788_, this, pt, p_117791_, p_117792_, p_117793_));
    }

    private void setModelProperties(FakePlayer p_117819_) {
        PlayerModel<FakePlayer> playermodel = this.getModel();
    ...
    private static HumanoidModel.ArmPose getArmPose(FakePlayer p_117795_, InteractionHand p_117796_) {
...
*/
    ...
    @Override
    public ResourceLocation getTextureLocation(FakePlayer p_114482_) {
