...
public class LCASoundEvents {
    ...
    public static void registerKeysSoundEvent(Instrument instrument, int note) {
        ...
        SoundEvent soundEvent = new SoundEvent(new ResourceLocation(LCAddon.MODID, soundName));
    ...
    public static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> new SoundEvent(new ResourceLocation(LCAddon.MODID, name)));
    }
